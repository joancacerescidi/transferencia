    ...
    <main class="bg-body-bg">
        <section class="py-20 px-6 xl:px-10">
            ...
            <h2 class="text-center text-xl xl:text-4xl font-bold mb-6 xl:mb-14">
                CONSORCIO CON PROVEEDORES RECIÉN CREADOS <br>
                {{ $nameEntidad }}
            </h2>
            <article
                ...
                <header
                    ...
                    <a href=" @if ($busquedaPalabra !== null) {{ url('/detail/first/crc/' . $rucEntidad . '/' . $period . '/' . $nameEntidad . '/' . $ruta . '/default' . '/cantidad' . '/' . $busquedaPalabra) }}
                    @else
                        {{ url('/detail/first/crc/' . $rucEntidad . '/' . $period . '/' . $nameEntidad . '/' . $ruta . '/default' . '/cantidad' . '/' . $busquedaPalabra) }} @endif "
                    ...
                    <a href=" @if ($busquedaPalabra !== null) {{ url('/detail/first/crc/' . $rucEntidad . '/' . $period . '/' . $nameEntidad . '/' . $ruta . '/default' . '/monto' . '/' . $busquedaPalabra) }}
                    @else
                        {{ url('/detail/first/crc/' . $rucEntidad . '/' . $period . '/' . $nameEntidad . '/' . $ruta . '/default' . '/monto' . '/' . $busquedaPalabra) }} @endif "

        ...
        <section class="py-20 px-6 xl:px-10">
            ...
            <article
                ...
                <header
                    ...
                    <a href=" @if ($busquedaPalabra !== null) {{ url('/detail/first/pmr/' . $rucEntidad . '/' . $period . '/' . $nameEntidad . '/' . $ruta . '/default' . '/cantidad' . '/' . $busquedaPalabra) }}
                    @else
                        {{ url('/detail/first/pmr/' . $rucEntidad . '/' . $period . '/' . $nameEntidad . '/' . $ruta . '/default' . '/cantidad' . '/' . $busquedaPalabra) }} @endif "
                    ...
                    <a href=" @if ($busquedaPalabra !== null) {{ url('/detail/first/pmr/' . $rucEntidad . '/' . $period . '/' . $nameEntidad . '/' . $ruta . '/default' . '/monto' . '/' . $busquedaPalabra) }}
                    @else
                        {{ url('/detail/first/pmr/' . $rucEntidad . '/' . $period . '/' . $nameEntidad . '/' . $ruta . '/default' . '/monto' . '/' . $busquedaPalabra) }} @endif "
                    ...
                    @foreach ($result as $item)
                        <p class="xl:col-span-1 font-semibold grid grid-cols-2 xl:block items-center gap-8">
                            ...
                            @if ($busquedaPalabra !== null)
                                <a class="btn-preload"
                                    href="{{ url('/detail/second/pmr/' . $item->ruc_contratista . '/' . $rucEntidad . '/' . $period . '/' . $nameEntidad . '/' . $item->ruc_contratista . '/' . $item->nombre_contratista . '/' . $ruta . '/' . $primaryVariable . '/monto_contratado_item' . '/' . $busquedaPalabra) }}">{{ $item->ruc_contratista }}
                                </a>
                            @else
                                <a class="btn-preload"
                                    href="{{ url('/detail/second/pmr/' . $item->ruc_contratista . '/' . $rucEntidad . '/' . $period . '/' . $nameEntidad . '/' . $item->ruc_contratista . '/' . $item->nombre_contratista . '/' . $ruta . '/' . $primaryVariable . '/monto_contratado_item') }}">{{ $item->ruc_contratista }}
                                </a>
                            @endif
                        </p>

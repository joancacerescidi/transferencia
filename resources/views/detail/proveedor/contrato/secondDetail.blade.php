    ...
    <main class="bg-body-bg">
        <section class="py-20 px-6 xl:px-10">
            <a href="#" class="flex items-center gap-3 mb-8 xl:mb-16 font-semibold text-sm xl:text-lg text-main-blue">
                ...
                @if ($busquedaPalabra !== null)
                    <span class="btn-preload"
                        onclick="window.location='{{ url('/detail/contrato/first/proveedor/' . $rucContratista . '/' . $period . '/monto' . '/' . $nombre . '/' . $busquedaPalabra) }}'">/
                        1° Detalle</span>
                @else
                    <span class="btn-preload"
                        onclick="window.location='{{ url('/detail/contrato/first/proveedor/' . $rucContratista . '/' . $period . '/monto' . '/' . $nombre) }}'">/
                        1° Detalle</span>
                @endif
            ...
            <h2 class="text-center text-xl xl:text-4xl font-bold mb-6 xl:mb-14">
                CONTRATO <br> {{ $nombre }}<br> {{ $ruc }} <br>{{ $rucNombre }}
            </h2>
            ...
            <article
                ...
                <header
                    ...
                    <a href=" @if ($busquedaPalabra !== null) {{ url('/detail/contrato/second/proveedor/' . $rucEntidad . '/' . $rucContratista . '/' . $period . '/' . $ruc . '/' . $rucNombre . '/fecha_suscripcion_contrato' . '/' . $nombre . '/' . $busquedaPalabra) }}
                    @else
                       {{ url('/detail/contrato/second/proveedor/' . $rucEntidad . '/' . $rucContratista . '/' . $period . '/' . $ruc . '/' . $rucNombre . '/fecha_suscripcion_contrato' . '/' . $nombre) }} @endif "
                    ...
                    <a href=" @if ($busquedaPalabra !== null) {{ url('/detail/contrato/second/proveedor/' . $rucEntidad . '/' . $rucContratista . '/' . $period . '/' . $ruc . '/' . $rucNombre . '/monto_contratado_item' . '/' . $nombre . '/' . $busquedaPalabra) }}
                    @else
                       {{ url('/detail/contrato/second/proveedor/' . $rucEntidad . '/' . $rucContratista . '/' . $period . '/' . $ruc . '/' . $rucNombre . '/monto_contratado_item' . '/' . $nombre) }} @endif "

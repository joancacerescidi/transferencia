...
class HomeController extends Controller
{
    ...
    public function detalle1($ruc, $type)
    {
        ...
        $dataDetalle1 = DB::select("SELECT periodo, ruc_entidad, nombre_entidad, ruc_contratista, nombre_contratista, monto, cantidad FROM public.$queryType where ruc_entidad=?", [$ruc]);

        return view('detail', compact('dataDetalle1', 'title', 'type'));
    }
    public function detalle2($rucEntidad, $rucContratista, $type)
    {
        ...
        return view('detail2', compact('title', 'object1'));
    }
    ...
    public function compra($rucEntidad, $rucContratista, $compra)
    {
        ...
        $dataCompra = DB::select("SELECT periodo, entidad, ruc_entidad, fecha_registro, fecha_emision, fecha_compromiso_presupuestal, fecha_de_notificacion, tipoorden, 
	                              ...
	                              FROM public.$compra
                                  where ruc_entidad=? and ruc_contratista=?", [$rucEntidad, $rucContratista]);
        return  $dataCompra;
    }

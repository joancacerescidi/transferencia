<div>
    <article
        class="p-5 xl:p-10 bg-white border border-gray-200 shadow-sm rounded-xl mb-6 cursor-pointer hover:shadow-lg overflow-x-auto">
        <header
            class="hidden xl:grid grid-cols-2 xl:grid-cols-15 gap-4 items-center text-xs xl:text-sm mb-6 xl:mb-14 xl:overflow-x-auto u-table-row">
        ...
        <div
            class="grid xl:grid-cols-15 items-start gap-4 text-xs xl:text-sm mb-10 border-b pb-4 xl:pb-0 xl:border-0 xl:overflow-x-auto u-table-row">
            @foreach ($collection as $key => $item)
                ...
                <p class="xl:col-span-1 font-medium grid grid-cols-2 xl:block items-center gap-8">
                    ...
                    <span> {{ $item->nombre_razon_contratista }}</span>
                </p>
                <p class="xl:col-span-1 font-medium grid grid-cols-2 xl:block items-center gap-8">

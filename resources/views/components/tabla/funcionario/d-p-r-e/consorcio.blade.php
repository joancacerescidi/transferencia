<div>
    <article
        ...
        <header
            class="hidden xl:grid grid-cols-2 xl:grid-cols-17 gap-4 items-center text-xs xl:text-sm mb-6 xl:mb-14 xl:overflow-x-auto u-table-row">
        ...
        <div
            class="grid xl:grid-cols-17 items-start gap-4 text-xs xl:text-sm mb-10 border-b pb-4 xl:pb-0 xl:border-0 xl:overflow-x-auto u-table-row">

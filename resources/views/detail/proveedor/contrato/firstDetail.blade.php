        ...
        <section class="py-20 px-6 xl:px-10">
            ...
            <article
                ...
                <header
                    ...
                    <a href=" @if ($busquedaPalabra !== null) {{ url('/detail/contrato/first/proveedor/' . $rucContratista . '/' . $period . '/cantidad' . '/' . $nombre . '/' . $busquedaPalabra) }}
                    @else
                        {{ url('/detail/contrato/first/proveedor/' . $rucContratista . '/' . $period . '/cantidad' . '/' . $nombre) }} @endif "
                    ...
                    <a href=" @if ($busquedaPalabra !== null) {{ url('/detail/contrato/first/proveedor/' . $rucContratista . '/' . $period . '/monto' . '/' . $nombre . '/' . $busquedaPalabra) }}
                    @else
                        {{ url('/detail/contrato/first/proveedor/' . $rucContratista . '/' . $period . '/monto' . '/' . $nombre) }} @endif "
                ...
                <div
                    ...
                    @foreach ($result as $item)
                        <p class="xl:col-span-1 font-semibold grid grid-cols-2 xl:block items-center gap-8">
                            ...
                            @if ($busquedaPalabra !== null)
                                <a class="btn-preload"
                                    href="{{ url('/detail/contrato/second/proveedor/' . $item->ruc_entidad . '/' . $rucContratista . '/' . $period . '/' . $item->ruc_entidad . '/' . $item->nombre_entidad . '/fecha_suscripcion_contrato' . '/' . $nombre . '/' . $busquedaPalabra) }}">{{ $item->ruc_entidad }}</a>
                            @else
                                <a class="btn-preload"
                                    href="{{ url('/detail/contrato/second/proveedor/' . $item->ruc_entidad . '/' . $rucContratista . '/' . $period . '/' . $item->ruc_entidad . '/' . $item->nombre_entidad . '/fecha_suscripcion_contrato' . '/' . $nombre) }}">{{ $item->ruc_entidad }}</a>
                            @endif

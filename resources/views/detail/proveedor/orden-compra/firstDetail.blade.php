        ...
        <section class="py-20 px-6 xl:px-10">
            ...
            <article
                ...
                <header
                    ...
                    <a href=" @if ($busquedaPalabra !== null) {{ url('/detail/orden-compra/first/proveedor/' . $rucContratista . '/' . $period . '/cantidad' . '/' . $nombre . '/' . $busquedaPalabra) }}
                    @else
                        {{ url('/detail/orden-compra/first/proveedor/' . $rucContratista . '/' . $period . '/cantidad' . '/' . $nombre) }} @endif "
                    ...
                    <a href=" @if ($busquedaPalabra !== null) {{ url('/detail/orden-compra/first/proveedor/' . $rucContratista . '/' . $period . '/monto' . '/' . $nombre . '/' . $busquedaPalabra) }}
                    @else
                        {{ url('/detail/orden-compra/first/proveedor/' . $rucContratista . '/' . $period . '/monto' . '/' . $nombre) }} @endif "
                ...
                <div
                    ...
                    @foreach ($result as $item)
                        <p class="xl:col-span-1 font-semibold grid grid-cols-2 xl:block items-center gap-8">
                            ...
                            @if ($busquedaPalabra !== null)
                                <a class="btn-preload"
                                    href="{{ url('/detail/orden-compra/second/proveedor/' . $item->ruc_entidad . '/' . $rucContratista . '/' . $period . '/' . $item->ruc_entidad . '/' . $item->entidad . '/oc.fecha_emision' . '/' . $nombre . '/' . $busquedaPalabra) }}">{{ $item->ruc_entidad }}</a>
                            @else
                                <a class="btn-preload"
                                    href="{{ url('/detail/orden-compra/second/proveedor/' . $item->ruc_entidad . '/' . $rucContratista . '/' . $period . '/' . $item->ruc_entidad . '/' . $item->entidad . '/oc.fecha_emision' . '/' . $nombre) }}">{{ $item->ruc_entidad }}</a>
                            @endif
